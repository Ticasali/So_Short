...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/19 03:16:35 by ticasali          #+#    #+#             */
/*   Updated: 2025/03/19 12:02:20 by ticasali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/Elaym.h"
/*
bool	load_player_two(t_Wind *wind, t_Play *play)
{
	play->yframe = 6;
	play->xframe = 0;
